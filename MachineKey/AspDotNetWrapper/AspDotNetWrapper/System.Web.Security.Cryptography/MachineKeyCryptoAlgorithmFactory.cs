    ...
    internal sealed class MachineKeyCryptoAlgorithmFactory : ICryptoAlgorithmFactory {
        ...
        private Func<SymmetricAlgorithm> GetEncryptionAlgorithmFactory() {
            return GetGenericAlgorithmFactory<SymmetricAlgorithm>(
                ...
                //SOURCE_CHANGED
                configAttributeValue: _machineKeySection.Decryption,
...
#pragma warning restore 618
                ...
                //SOURCE_CHANGED
                errorResourceString: "The decryption must be one of these values: Auto, DES, 3DES, AES or alg:[SymmetricAlgorithm].");
        }
        ...
        private Func<KeyedHashAlgorithm> GetValidationAlgorithmFactory() {
            return GetGenericAlgorithmFactory<KeyedHashAlgorithm>(
                ...
                //SOURCE_CHANGED
                configAttributeValue: _machineKeySection.ValidationAlgorithm,
                switchStatement: algorithmName => {
                    switch (algorithmName) {
                        case "SHA1":
                ...
                //SOURCE_CHANGED
                errorResourceString: "When using <machineKey compatibilityMode=\"Framework45\" /> or the MachineKey.Protect and MachineKey.Unprotect APIs, the 'validation' attribute must be one of these values: SHA1, HMACSHA256, HMACSHA384, HMACSHA512, or alg:[KeyedHashAlgorithm].");
        }
